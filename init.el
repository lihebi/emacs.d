...
(custom-set-variables
 ...
 '(org-agenda-files
   (quote
    ("~/github/bibliography/newdir/similarity.org" "~/github/note/TODO.org")))
 '(org-file-apps
   (quote
    ((auto-mode . emacs)
     ("\\.mm\\'" . default)
